...
def execute_basic_tool(tool_call, tracer=None) -> str:
    import json
    from agent_hemo.utils.logger import AgentTracer, get_current_tracer
    tracer = tracer or get_current_tracer() or AgentTracer()
